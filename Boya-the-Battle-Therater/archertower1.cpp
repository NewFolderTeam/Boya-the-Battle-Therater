#include "archertower1.h"

ArcherTower1::ArcherTower1(const int x, const int y)
    : Tower(x,y)
{
    width = 100, height = 100;   //防御塔宽高
    picturePath = ":/image/atw1.png";    //防御塔图片路径
    type = 1;
    attackInterval = 6;
    range = 150;
    cost = 70;
...
//攻击函数
void ArcherTower1::Attack(QVector<Enemy*>& enemyVec)
{
